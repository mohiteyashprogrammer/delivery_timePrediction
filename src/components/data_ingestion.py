...
## initalizing the data ingestion configure
...
class DataIngestion:
    ...
    def initated_data_ingestion(self):
        ...
        try:
            data = pd.read_csv(os.path.join("notebook/data","clean_delivery_time.csv"))
            ...
            logging.info("Error Occure in Data Ingestion")
